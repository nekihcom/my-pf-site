  ...
  return (
    <>
      ...
      <Grid2 container spacing={{ xs:1, sm:5 }} columns={{ xs:1, md:2, lg:3 }} sx={{ justifyContent:'space-evenly' }}>
        <WorkItem title={'Netflix Clone'} description={'Netflixのクローンアプリ、予告動画も見れます'} image={'/work/netflix-clone.png'} url={'https://nf-clone-sigma-amber.vercel.app/'} detailDescription={'ここに詳細な説明が入ります。ここに詳細な説明が入ります。ここに詳細な説明が入ります。ここに詳細な説明が入ります。ここに詳細な説明が入ります。'} />
